...
To run the workflow, simply run `run-all.sh` on POSIX or `run-all.cmd` on Windows. It expects you to have Deno installed, but you can replace its usage with Node.js if you want.
